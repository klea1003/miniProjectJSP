		...
		<!-- <div class="col-lg-4"> -->	<!-- 영역 크기 --> <!-- 이 태그 생략 -->
			...
			<div class="jumbotron" style="padding-top: 20px;">
				<form method="post" action="updateUserAction.jsp">
					<h3 style="text-align: center;">회원 정보 수정</h3>  <!-- !!제목 수정 -->
					<div class="form-group">
						<input type="text" class="form-control" placeholder="아이디" name="userID" maxlength="20" value="<%= user.getUserID() %>" readonly> <!-- !!readonly 추가 -->
					</div>
					<div class="form-group">
					...
					<input type="submit" class="btn btn-primary form-control" value="정보수정"> <!-- !! value값 수정 -->
				</form>
			</div>
		<!-- </div> --> <!-- 이 태그 생략 -->	
	</div>
