...
<nav class="navbar navbar-default" style="margin-bottom: 0;">
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand"
			href="<%=request.getContextPath()%>/product/MainCategoryView.jsp">INDIEBOOK</a>
	</div>
		...
		<ul class="nav navbar-nav navbar-right">
			<li class="dropdown"><a href="#" class="dropdown-toggle"
				...
				<ul class="dropdown-menu">
					...
					<li><a
						href="<%=request.getContextPath()%>/user/updateUser.jsp">정보수정</a></li>
				</ul></li>
		</ul>
	...
	%>
		<ul class="nav navbar-nav navbar-right">
			<li><a
				href="<%=request.getContextPath()%>/user/logoutAction.jsp">로그아웃</a></li>
		</ul>
...
<aside class="side">
	<div class="container1">
		...
		<div class="item1">
			<a href="<%=request.getContextPath()%>/product/MainCategoryView.jsp">장르별 베스트 셀러</a>
		</div>
		<% 
